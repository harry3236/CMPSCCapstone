...
aa_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('Black or African American')
asian_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('Asian')
native_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('American Indian or Native Alaskan')
white_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('White')
pacific_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('Native Hawaiian or Pacific Islander')
two_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('Two or more races')
latino_acceptance_2017 =acceptance2017.groupby(acceptance2017.SchoolName).get_group('Hispanic/Latino')
